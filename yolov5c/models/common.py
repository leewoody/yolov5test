...
class Conv(nn.Module):
    ...
    def __init__(self, c1, c2, k=1, s=1, p=None, g=1, d=1, act=True):
        super().__init__()
#        if c1 % g != 0:
#            raise ValueError(f'in_channels must be divisible by groups: in_channels={c1}, groups={g}')
#        print(f"Initializing Conv: in_channels={c1}, out_channels={c2}, groups={g}")
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, e=0.5):  # ch_in, ch_out, shortcut, groups, expansion
        ...
        if c_ % g != 0:
            print(f'Bottleneck init: c1={c1}, c2={c2}, c_={c_}, g={g}')
...
class C3(nn.Module):
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):  # Adjust 'g' to be a divisor of 'c1'
        super().__init__()
        c_ = int(c2 * e)
        self.cv1 = Conv(c1, c_, 1, 1)
        ...
        # Make sure g is a divisor of c_
        self.m = nn.Sequential(*(Bottleneck(c_, c_, shortcut, g=g, e=1.0) for _ in range(n)))
